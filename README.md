 ...
 <p align="center">Welcome to my GitHub! I am a graduating senior completing my B.S. in Computer Science with a minor in Mathematics. Additionally, I hold an A.S. in Engineering. Currently I work as a software developer at a technical research institution, and working on my senior project using machine learning algorithms to train a new AI. I am a sponge when it comes to new knowledge, so I am always open to collaborations! As a person who values their inner childlike wonder and curiosity, I hope I can push boundaries, have fun, and empower others through coding.</p>
